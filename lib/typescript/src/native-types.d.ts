...
export declare type HKSampleTypeIdentifier = HKWorkoutTypeIdentifier | HKQuantityTypeIdentifier | HKCategoryTypeIdentifier | HKClinicalTypeIdentifier | HKDocumentTypeIdentifier | HKAudiogramTypeIdentifier | HKCorrelationTypeIdentifier;
...
export declare enum HKClinicalTypeIdentifier {
...
export declare type HKClinicalSampleRaw = {
...
export declare enum HKDocumentTypeIdentifier {
    CDA = "HKDocumentTypeIdentifierCDA"
}
export declare type HKDocumentSampleRaw = {
    uuid: string;
    device?: HKDevice;
...
declare type ReactNativeHealthkitTypeNative = {
    ...
    queryClinicalSamples: (typeIdentifier: HKClinicalTypeIdentifier, from: string, to: string, limit: Number, ascending: boolean) => Promise<HKClinicalSampleRaw[]>;
    queryDocumentSamples: (typeIdentifier: HKDocumentTypeIdentifier, from: string, to: string, limit: Number, ascending: boolean) => Promise<HKDocumentSampleRaw[]>;
