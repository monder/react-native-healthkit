...
export declare type GetRequestStatusForAuthorizationFn = (read: (HKCharacteristicTypeIdentifier | HKSampleTypeIdentifier)[], write?: Exclude<HKSampleTypeIdentifier, HKClinicalTypeIdentifier>[]) => Promise<HKAuthorizationRequestStatus>;
export declare type RequestAuthorizationFn = (read: (HKCharacteristicTypeIdentifier | HKSampleTypeIdentifier)[], write?: Exclude<HKSampleTypeIdentifier, HKClinicalTypeIdentifier>[]) => Promise<boolean>;
...
export declare type MostRecentClinicalSampleHook = <T extends HKClinicalTypeIdentifier>(identifier: T) => HKClinicalSample | null;
export declare type MostRecentDocumentSampleHook = <T extends HKDocumentTypeIdentifier>(identifier: T) => HKDocumentSample | null;
...
export interface HKClinicalSample extends Omit<HKClinicalSampleRaw, 'startDate' | 'endDate'> {
    startDate: Date;
    endDate: Date;
}
export interface HKDocumentSample extends Omit<HKDocumentSampleRaw, 'startDate' | 'endDate'> {
    startDate: Date;
    endDate: Date;
}
...
export declare type QueryClinicalSamplesFn = (typeIdentifier: HKClinicalTypeIdentifier, options: GenericQueryOptions) => Promise<HKClinicalSample[]>;
export declare type QueryDocumentSamplesFn = (typeIdentifier: HKDocumentTypeIdentifier, options: GenericQueryOptions) => Promise<HKDocumentSample[]>;
